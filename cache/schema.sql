...
CREATE INDEX IF NOT EXISTS idx_parser_cache_lookup 
    ON parser_cache(url, parser_type);
CREATE INDEX IF NOT EXISTS idx_parser_cache_accessed 
    ON parser_cache(accessed_at);
...
CREATE INDEX IF NOT EXISTS idx_agent_cache_lookup 
    ON agent_cache(url, parser_type, agent_pipeline);
CREATE INDEX IF NOT EXISTS idx_agent_cache_accessed 
    ON agent_cache(accessed_at);
